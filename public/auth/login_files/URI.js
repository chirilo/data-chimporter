...
(function(q, w) {
    "object" === typeof exports ? module.exports = w(require("./punycode"), require("./IPv6"), require("./SecondLevelDomains")) : "function" === typeof define && define.amd ? define(["./punycode", "./IPv6", "./SecondLevelDomains"], w) : q.URI = w(q.punycode, q.IPv6, q.SecondLevelDomains, q)
    ...
    e.parse = function(a, b) {
        ...
        "//" === a.substring(0, 2) ? (b.protocol = null,
            a = a.substring(2), a = e.parseAuthority(a, b)) : (c = a.indexOf(":"), -1 < c && (b.protocol = a.substring(0, c) || null, b.protocol && !b.protocol.match(e.protocol_expression) ? b.protocol = void 0 : "file" === b.protocol ? a = a.substring(c + 3) : "//" === a.substring(c + 1, c + 3) ? (a = a.substring(c + 3), a = e.parseAuthority(a, b)) : (a = a.substring(c + 1), b.urn = !0)));
        b.path = a;
        return b
    };
    ...
    e.parseUserinfo = function(a, b) {
        var c = a.indexOf("/"),
            g = -1 < c ? a.lastIndexOf("@", c) : a.indexOf("@"); - 1 < g && (-1 === c || g < c) ? (c = a.substring(0, g).split(":"), b.username =
            c[0] ? e.decode(c[0]) : null, c.shift(), b.password = c[0] ? e.decode(c.join(":")) : null, a = a.substring(g + 1)) : (b.username = null, b.password = null);
        return a
    };
    e.parseQuery = function(a, b) {
        ...
        if (!a) return {};
        for (var c = {}, g = a.split("&"), f = g.length, d, h, n = 0; n < f; n++) d = g[n].split("="), h = e.decodeQuery(d.shift(), b), d = d.length ? e.decodeQuery(d.join("="), b) : null, c[h] ? ("string" === typeof c[h] && (c[h] = [c[h]]), c[h].push(d)) : c[h] = d;
        return c
    };
    e.build = function(a) {
        var b = "";
    ...
    e.buildHost = function(a) {
        var b = "";
        if (a.hostname) b = e.ip6_expression.test(a.hostname) ? b + ("[" + a.hostname + "]") : b + a.hostname;
        else return "";
        a.port && (b += ":" + a.port);
        return b
    };
    e.buildAuthority = function(a) {
        return e.buildUserinfo(a) +
            e.buildHost(a)
    };
    ...
    e.buildQuery = function(a, b, c) {
        ...
        for (d in a)
            if (t.call(a, d) && d)
                if (l(a[d]))
                    for (f = {}, h = 0, n = a[d].length; h < n; h++) void 0 !== a[d][h] && void 0 === f[a[d][h] + ""] && (g += "&" + e.buildQueryParameter(d, a[d][h], c), !0 !== b && (f[a[d][h] + ""] = !0));
                else void 0 !== a[d] && (g += "&" + e.buildQueryParameter(d, a[d], c));
        return g.substring(1)
    };
    e.buildQueryParameter = function(a,
        b, c) {
        return e.encodeQuery(a, c) + (null !== b ? "=" + e.encodeQuery(b, c) : "")
    };
    e.addQuery = function(a, b, c) {
        if ("object" === typeof b)
            for (var g in b) t.call(b, g) && e.addQuery(a, g, b[g]);
    ...
    e.removeQuery = function(a, b, c) {
        var g;
        if (l(b))
            for (c = 0, g = b.length; c < g; c++) a[b[c]] = void 0;
        else if ("object" === typeof b)
            for (g in b) t.call(b,
                g) && e.removeQuery(a, g, b[g]);
                ...
                if (a[b] === c) a[b] = void 0;
                    ...
                    if (l(a[b])) {
                        ...
                        var f = {},
                            d, h;
                        if (l(c))
                            for (d = 0, h = c.length; d < h; d++) f[c[d]] = !0;
                        else f[c] = !0;
                        d = 0;
                        for (h = g.length; d < h; d++) void 0 !== f[g[d]] && (g.splice(d, 1), h--, d--);
                        a[b] = g
                    }
                } else a[b] = void 0;
    ...
    e.hasQuery = function(a, b, c, g) {
        if ("object" === typeof b) {
            for (var d in b)
                if (t.call(b, d) && !e.hasQuery(a, d, b[d])) return !1;
            return !0
        }
        if ("string" !==
    ...
    e.ensureValidHostname = function(a) {
        if (a.match(e.invalid_hostname_characters)) {
            if (!q) throw new TypeError('Hostname "' + a + '" contains characters other than [A-Z0-9.-] and Punycode.js is not available');
            if (q.toASCII(a).match(e.invalid_hostname_characters)) throw new TypeError('Hostname "' +
    ...
    e.noConflict = function(a) {
        if (a) return a = {
            URI: this.noConflict()
        }, p.URITemplate && "function" === typeof p.URITemplate.noConflict && (a.URITemplate = p.URITemplate.noConflict()), p.IPv6 && "function" === typeof p.IPv6.noConflict && (a.IPv6 = p.IPv6.noConflict()), p.SecondLevelDomains && "function" === typeof p.SecondLevelDomains.noConflict && (a.SecondLevelDomains = p.SecondLevelDomains.noConflict()), a;
        p.URI === this && (p.URI = C);
        return this
    };
    d.build = function(a) {
    ...
    d.href = function(a, b) {
        ...
        if ("string" === typeof a) this._parts = e.parse(a, this._parts);
            ...
            for (c in g = g ? a._parts : a, g) t.call(this._parts, c) && (this._parts[c] = g[c]);
    ...
    d.tld = function(a, b) {
        ...
        if (a)
            if (a.match(/[^a-zA-Z0-9-]/))
                if (v && v.is(a)) c = new RegExp(s(this.tld()) + "$"), this._parts.hostname = this._parts.hostname.replace(c, a);
    ...
    d.suffix = function(a, b) {
        ...
        "." === a.charAt(0) && (a = a.substring(1));
        if (c = this.suffix()) d = a ? new RegExp(s(c) + "$") : new RegExp(s("." + c) + "$");
        else {
            if (!a) return this;
    ...
    d.segment = function(a, b, c) {
        var e = this._parts.urn ? ":" : "/",
            ...
            d = d.split(e);
        void 0 !==
            a && "number" !== typeof a && (c = b, b = a, a = void 0);
        ...
        if (null === a || void 0 === d[a])
            ...
            } else b || "string" === typeof b && b.length ?
            d[a] = b : d.splice(a, 1);
        k && d.unshift("");
    ...
    d.segmentCoded = function(a, b, c) {
        ...
        if (l(b))
            for (d = 0, f = b.length; d < f; d++) b[d] = e.decode(b[d]);
    ...
    d.addQuery = function(a, b, c) {
        ...
        this._parts.query =
            e.buildQuery(d, this._parts.duplicateQueryParameters, this._parts.escapeQuerySpace);
        "string" !== typeof a && (c = b);
        this.build(!c);
        return this
    };
    ...
    d.normalizePath =
        function(a) {
            ...
            for (;;) {
                ...
                k = c.substring(0, f).lastIndexOf("/"); - 1 === k && (k = f);
    ...
    d.readable = function() {
        ...
        if (a._parts.query) {
            for (var c = "", d = 0, f = a._parts.query.split("&"), k = f.length; d < k; d++) {
                var h = (f[d] || "").split("="),
                    c = c + ("&" + e.decodeQuery(h[0], this._parts.escapeQuerySpace).replace(/&/g, "%26"));
    ...
    d.absoluteTo = function(a) {
        ...
        "/" !== b.path().charAt(0) && (a = a.directory(), b._parts.path = (a ?
            a + "/" : "") + b._parts.path, b.normalizePath());
        b.build();
        return b
    };
    d.relativeTo = function(a) {
        ...
        if (c.username ===
            d.username && c.password === d.password && null === c.protocol && null === c.username && null === c.password && c.hostname === d.hostname && c.port === d.port) c.hostname = null, c.port = null;
        else return b.build();
